# 📈 Performance Studio
> Generate k6 Javascript loads, Locust Python tasks, and execution runbooks for system scalability benchmarking.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/performance/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/performance/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-performance.git
cd tp-performance
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/performance/) |
